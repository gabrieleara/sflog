...
function(set_index the_list the_value the_output)
    ...
    foreach(string IN LISTS mylist)
...
function(check_optional_library library_name)
    ...
    if(${library_name})
        ...
        set(RTDAG_${library_name_upper}_USE ON CACHE BOOL "INTERNAL CONFIG VARIABLE DO NOT SET MANUALLY" FORCE)
        mark_as_advanced(RTDAG_${library_name_upper}_USE)
    else()
        set(RTDAG_${library_name_upper}_USE OFF CACHE BOOL "INTERNAL CONFIG VARIABLE DO NOT SET MANUALLY" FORCE)
        mark_as_advanced(RTDAG_${library_name_upper}_USE)
...
function(target_optional_link_library target library_name)
    ...
    if(${library_name})
        if(RTDAG_${library_name_upper}_USE)
